...
(function ($) {
	...
	$(document).ready(function () {
		...
		*/
		...
		$('#booking-doctors-list-table').DataTable({
			"language": dataTableLanguage,
			"lengthMenu": [25, 50, 75, 100],
			"order": [[ 0, "desc" ]]
		})

		$('#booking-clinic-list-table').DataTable({
			"language": dataTableLanguage,
		...
		$('.profile_picture')
			.mouseover(() => {
				var el = $('.slim-btn-group')[0]
				if (el.style.display != 'none') {
					$('.slim-btn-group')[0].style.flexDirection = 'row-reverse';
					$('.slim-btn-remove')[0].style.display = 'block';
				}
			})
			.mouseout(() => {
				var el = $('.slim-btn-group')[0]
				if (el.style.display != 'none') {
					$('.slim-btn-group')[0].style.flexDirection = 'row';
					$('.slim-btn-remove')[0].style.display = 'none';
				}
			})
